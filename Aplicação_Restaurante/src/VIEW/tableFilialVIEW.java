...
public class tableFilialVIEW extends javax.swing.JFrame {
    ...
    /**
     * Creates new form tableFilialVIEW
     */
    public tableFilialVIEW() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabelaFiliais.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Endereço", "Email", "Telefone", "Quantidade_Mesas", "Avaliação"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tableFilialVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void listarValoresFilial(){
        try {
            ...
            ArrayList<FilialDTO> lista = objFilialDAO.listarFilial();
